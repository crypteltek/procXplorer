...
set_target_properties(slint_cpp-shared PROPERTIES IMPORTED_LOCATION;${_IMPORT_PREFIX}/lib/slint_cpp.dll;IMPORTED_LOCATION_DEBUG;${_IMPORT_PREFIX}/lib/slint_cpp.dll;IMPORTED_LOCATION_RELEASE;${_IMPORT_PREFIX}/lib/slint_cpp.dll;IMPORTED_LOCATION_RELWITHDEBINFO;${_IMPORT_PREFIX}/lib/slint_cpp.dll;IMPORTED_LOCATION_MINSIZEREL;${_IMPORT_PREFIX}/lib/slint_cpp.dll;IMPORTED_IMPLIB;${_IMPORT_PREFIX}/lib/slint_cpp.dll.lib;IMPORTED_IMPLIB_DEBUG;${_IMPORT_PREFIX}/lib/slint_cpp.dll.lib;IMPORTED_IMPLIB_RELEASE;${_IMPORT_PREFIX}/lib/slint_cpp.dll.lib;IMPORTED_IMPLIB_RELWITHDEBINFO;${_IMPORT_PREFIX}/lib/slint_cpp.dll.lib;IMPORTED_IMPLIB_MINSIZEREL;${_IMPORT_PREFIX}/lib/slint_cpp.dll.lib;IMPORTED_NO_SONAME;TRUE)

function(_slint_download_compiler_and_cache)
    set(SLINT_GITHUB_RELEASE "v1.17.1" CACHE STRING "GitHub Release to use for Slint Binary Artifact Downloads")
...
elseif (ON)
    add_executable(Slint::slint-compiler IMPORTED GLOBAL)
    set_target_properties(Slint::slint-compiler PROPERTIES IMPORTED_LOCATION "${_IMPORT_PREFIX}/bin/slint-compiler.exe")
    include("${CMAKE_CURRENT_LIST_DIR}/SlintMacro.cmake")
endif()
